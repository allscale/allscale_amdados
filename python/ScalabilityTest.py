...
if __name__ == "__main__":
    try:
        ...
        for res_no, res in enumerate(Resolutions):
            ...
            # Get global problem size.
            exe_time_profile[res_no,1] = \
                    conf.num_subdomains_x * conf.subdomain_x * \
                    conf.num_subdomains_y * conf.subdomain_y;

        SimplePlot(exe_time_profile,
                    "problem size as the number of nodal points",
                    "execution time in seconds",
                    "Scalability of C++ amdados application",
                    os.path.join(conf.output_dir, "scalability.png"))
